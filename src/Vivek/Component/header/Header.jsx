                            ...
                            <div className='VK_header_nav d-flex justify-content-center overflow-hidden'>
                                ...
                                <ul className='w-100 VK_sub_scroll_bar list-unstyled justify-content-between m-0 p-0 d-flex flex-nowrap overflow-auto white_space'
                                    ...
                                    <li className='VK_sub_menu'>
                                        <Link to='/women' className='text-decoration-none d_headertext'>Women</Link>
                                    ...
                                    <li className='VK_sub_menu'>
                                        <Link to='/beauty' className='text-decoration-none d_headertext'>Beauty & Health</Link>
                                        <div className='VK_mega_menu'>
                                            <div className='VK_mega_menu_div_parent'>
                                                <div className='VK_menu_list'>
                                                    <p className='mb-2 font_18 header_color inter'>
                                    ...
                                    <li className='VK_sub_menu'>
                                        <Link to='/electronics' className='text-decoration-none d_headertext'></Link>Electronics & Mobiles
                                        <div className='VK_mega_menu'>
                                            <div className='VK_mega_menu_div_parent'>
                                                <div className='VK_menu_list'>
                                                    <p className='mb-2 font_18 header_color inter'>
                                    ...
                                    <li className='VK_sub_menu'>
                                        <Link to='sports' className='text-decoration-none d_headertext'>Sports</Link>
                                        <div className='VK_mega_menu'>
                                            <div className='VK_mega_menu_div_parent'>
                                                <div className='VK_menu_list'>
                                                    <p className='mb-2 font_18 header_color inter'>
                                    ...
                                    <li className='VK_sub_menu'>
                                        <Link to='/luggage' className='text-decoration-none d_headertext'>Luggage</Link>
                                        <div className='VK_mega_menu'>
                                            <div className='VK_mega_menu_div_parent'>
                                                <div className='VK_menu_list'>
                                                    <p className='mb-2 font_18 header_color inter'>
