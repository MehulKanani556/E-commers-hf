                  ...
                  {popularbarnd.map((item) => (
                    <div className={`div${cnt++} VK_grid_parent`}>
                      <img
                        ...
                        className="w-100 h-100 object_center"
                        alt=""
                      />
                        ...
                        <div className="h-100 d-flex flex-column">
                          <div className="d-flex">
                            <div className="VK_grid_logo text-center">
                              <img
                                src={`${BaseUrl}/${item?.brandLogo}`}
                                className="mv_brand_logo_img"
                                alt=""
                              />
                          ...
                          <div className="mt-auto">
                            <h4 className="VK_pro_heading">{item.title}</h4>
                            <div>
                              <Link to={`/Product/${item.brandName}`}>
